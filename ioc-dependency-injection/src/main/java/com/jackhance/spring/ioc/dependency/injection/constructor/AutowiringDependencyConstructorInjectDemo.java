...
/**
 * 自动注入，实现 constructor 方法依赖注入示例
 *
 * @author jackhance
 * @mail jackhance0825@163.com
 */
public class AutowiringDependencyConstructorInjectDemo {
    ...
    public static void main(String[] args) {
        ...
        // 依赖查找 WorkerHolder
        WorkerHolder workerHolderByConstructor = beanFactory.getBean("workerHolderByConstructor", WorkerHolder.class);
        System.out.println("workerHolderByConstructor=" + workerHolderByConstructor);
